...
#### Welcome to [the Igni project](http://igni-project.org); an open source project which aims to further advance spatial computing and the metaverse*.

* The "metaverse" as defined by [dictionary.com](https://www.dictionary.com/browse/metaverse), sans all connotations
